...
//
//     final pokedexJson = pokedexJsonFromJson(jsonString);

import 'dart:convert';

PokedexJson pokedexJsonFromJson(String str) => PokedexJson.fromJson(json.decode(str));

String pokedexJsonToJson(PokedexJson data) => json.encode(data.toJson());
...
class PokedexJson {
  ...
  factory PokedexJson.fromJson(Map<String, dynamic> json) => PokedexJson(
